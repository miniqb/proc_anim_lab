...
HASH_ORIGINAL_HIT=2AB518F42E5D98AC
HASH_ORIGINAL_MISS=014A23A955948A2C
HASH_ORIGINAL_OCCLUDED=AB0D36CFF9433ECC
HASH_SHORT_CEILING_HIT=83E5277FF9E392C6
HASH_HUNTER_WALL_HIT=B1E4755878259DCF
...
run hunter-wall-edge-miss tentacle-plant/hunter wall miss 450 400 \
    --plant-target-local=9,0.9,0.45
# 用户复现的大攻角位置：必须在第一次 12-tick 扑击内抓中，不能靠余窗慢慢碰到。
run hunter-floor-oblique-hit tentacle-plant/hunter floor hit 220 400 \
    --plant-target-local=2.69,3.135,0 \
    --plant-min-strike-speed=0.9 \
    --plant-expect-hash="$HASH_HUNTER_FLOOR_OBLIQUE_HIT"
