...
# —— 哈希基线（2026-08-22 R15 实跑钉定；R17 断臂垂位侧偏重钉 sever-arm-walk /
# sever-all / sever-during-attack 三项；空 = 本轮不校验绝对值，仅跑行为门）——
HASH_WALK=3948E97A0546B92F
HASH_RUN=27861B859ABA2F02
HASH_YANK=5155CCC31F0C8790
HASH_SEVER_LEG=0064D8B5FE34B9B9
HASH_CRAWL_STEP=846F17EC9D4AE774
HASH_SEVER_ARM_WALK=C16F23C7819793E4
HASH_SEVER_BOTH_LEGS=95B9A840A1340762
HASH_SEVER_ALL=D778DDB578757BA0
HASH_ATTACK=C9FA8394023B587F
HASH_SEVER_DURING_ATTACK=52DD4E8FC2A19978
HASH_DUSK_WALK=3948E97A0546B92F   # 与 gaunt 逐位相同（dusk = 同体格调色变体，等值即断言）
HASH_BROAD_WALK=24E1CD29873BFD75
HASH_BROAD_SEVER_LEG=FD348EAB50310D74
HASH_WHELP_WALK=45CDF29D6B4E7304
HASH_WHELP_SEVER_LEG=6424404732D919BD
