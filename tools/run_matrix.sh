#!/bin/bash
# 确定性全矩阵回归：45 配置（20 Lizard + 13 Centipede + 4 Vulture + 8 Humanoid）× 硬断言
...
# 2026-08-23 停驶切向阻尼（StanceDamping）重定基线：只有含停驶段的六项换哈希，
# 四预设巡逻（全程有移动意图）逐字节不变；walkDistance/穿透/深断链不变，
# 停驶终态 endDev 与抓地腿数变好。详见 docs/centipede_controller.md。
...
HASH_CENTIPEDE_COURSE_SHORT=129EDA823C087292
HASH_CENTIPEDE_COURSE_LONG=78F8033FEF622F18
HASH_CENTIPEDE_STEP_DOWN_ARMORED=C39A33DB45EBB367
HASH_CENTIPEDE_NARROW_WALL_LONG_END=7611E4B219C400F9
HASH_CENTIPEDE_EMBED_LONG=9C41F605B14C3EE7
HASH_CENTIPEDE_WALLSIDE_LONG=13B10CEAF34AAF6E
